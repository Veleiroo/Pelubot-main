...
Usage examples:
  ...
  # custom range
  START=2025-09-06 END=2025-09-13 python -m backend.sync_cli

  # days ahead (overrides END)
  DAYS=14 python -m backend.sync_cli
...
from logic import sync_from_gcal_range, reconcile_db_to_gcal_range
