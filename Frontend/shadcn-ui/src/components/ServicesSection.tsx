...
export default function ServicesSection() {
  const services = [
    ...
    {
      icon: <Zap className="text-[#00D4AA]" size={32} />,
    ...
    {
      icon: <Crown className="text-[#00D4AA]" size={32} />,
      title: "Corte + Barba",
    ...
    {
      icon: <Sparkles className="text-[#00D4AA]" size={32} />,
    ...
    {
      icon: <Brush className="text-[#00D4AA]" size={32} />,
    ...
    {
      icon: <Star className="text-[#00D4AA]" size={32} />,
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-16">
          <h2 className="text-4xl md:text-5xl font-bold text-white mb-6">
            Nuestros <span className="text-[#00D4AA]">Servicios</span>
          </h2>
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
          {services.map((service, index) => (
            <div
              key={index}
              className="bg-[#1a1a1a] border border-gray-800 rounded-lg p-8 hover:border-[#00D4AA] transition-all duration-300 group hover:transform hover:scale-105"
            >
              <div className="flex items-center justify-between mb-6">
                <div className="p-3 bg-black rounded-lg group-hover:bg-[#00D4AA]/10 transition-colors">
                  {service.icon}
                </div>
                <div className="text-right">
                  <div className="text-2xl font-bold text-[#00D4AA]">{service.price}</div>
                </div>
              </div>
              ...
              <Button
                ...
                className="w-full bg-transparent border border-[#00D4AA] text-[#00D4AA] hover:bg-[#00D4AA] hover:text-black transition-all duration-300"
              >
                Reservar Ahora
              </Button>
            </div>
        ...
        <div className="text-center mt-12">
          ...
          <Button
            onClick={handleReservation}
            size="lg"
            className="bg-[#00D4AA] hover:bg-[#00B894] text-black font-bold px-8 py-4"
          >
