  ...
  const mergedClassNames = React.useMemo(() => {
    const base: Record<string, string | undefined> = {
      ...
      nav_button: cn(
        ...
        'h-7 w-7 p-0 text-muted-foreground hover:bg-muted/40 hover:text-foreground',
      ...
      day_button: cn(
        buttonVariants({ variant: 'ghost' }),
        'h-9 w-9 p-0 font-normal aria-selected:opacity-100 inline-flex items-center justify-center mx-auto text-foreground hover:bg-muted/40 hover:text-foreground transition-colors duration-200',
      ...
      day_today: cn('text-foreground font-semibold', classNames?.day_today),
      day_outside: cn(
