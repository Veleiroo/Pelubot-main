...
>(({ defaultOpen = true, open: openProp, onOpenChange: setOpenProp, className, style, children, ...props }, ref) => {
  ...
  const setOpen = React.useCallback(
    (value: boolean | ((value: boolean) => boolean)) => {
      ...
      // Guarda una cookie para mantener el estado de la barra lateral.
  ...
  // Añadimos un estado para poder usar data-state="expanded" o "collapsed".
  // Esto facilita el estilo con clases de Tailwind.
...
>(({ side = 'left', variant = 'sidebar', collapsible = 'offcanvas', className, children, ...props }, ref) => {
  ...
  return (
    <div
      ...
      data-side={side}
    >
      {/* Esto gestiona el hueco de la barra lateral en escritorio */}
      <div
        className={cn(
