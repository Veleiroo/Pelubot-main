...
export const STATUS_RING_STYLES: Record<OverviewAppointmentEntry['status'], string> = {
  confirmada: 'bg-amber-400/15 text-amber-200 ring-amber-400/30',
  asistida: 'bg-emerald-400/15 text-emerald-200 ring-emerald-400/30',
...
export const STATUS_TONE: Record<OverviewAppointmentEntry['status'], string> = {
  confirmada: 'text-amber-300',
  asistida: 'text-emerald-300',
